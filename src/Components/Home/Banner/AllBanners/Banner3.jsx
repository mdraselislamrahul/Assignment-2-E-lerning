...
import img from "./Image/first-slider.png"
const Banner3 = () => {
    return (
        <div>
            <div className="card lg:card-side md:card-side bg-red-100 shadow-xl py-10">
                ...
                <div className="card-body md:w-1/2">
                    ...
                    <h2 className="font-bold text-5xl mt-5">Different <span className='text-red-900 underline'>Spice </span>For <br />  A Defferent teste </h2>
